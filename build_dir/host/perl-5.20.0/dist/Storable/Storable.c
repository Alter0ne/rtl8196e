...
XS_EUPXS(XS_Storable_init_perinterp)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 6612 "Storable.xs"
  init_perinterp(aTHX);
#line 6750 "Storable.c"
    }
    XSRETURN_EMPTY;
}
...
;
	SV *	RETVAL;
#line 6662 "Storable.xs"
  RETVAL = pretrieve(aTHX_ f);
#line 6818 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
;
	SV *	RETVAL;
#line 6670 "Storable.xs"
  RETVAL = mretrieve(aTHX_ sv);
#line 6838 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
;
	SV *	RETVAL;
#line 6678 "Storable.xs"
  RETVAL = dclone(aTHX_ sv);
#line 6858 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS_EUPXS(XS_Storable_last_op_in_netorder)
{
    ...
    SP -= items;
    {
#line 6688 "Storable.xs"
  bool result;
#line 6878 "Storable.c"
#line 6690 "Storable.xs"
  if (ix) {
   dSTCXT;
