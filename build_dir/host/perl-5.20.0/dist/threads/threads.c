...
XS_EUPXS(XS_threads_self)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1182 "threads.xs"
        char *classname;
        ithread *thread;
#line 1361 "threads.c"
#line 1185 "threads.xs"
        /* Class method only */
...
XS_EUPXS(XS_threads_tid)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1200 "threads.xs"
        ithread *thread;
#line 1387 "threads.c"
#line 1202 "threads.xs"
...
XS_EUPXS(XS_threads_detach)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1344 "threads.xs"
        ithread *thread;
        int detach_err;
        dMY_POOL;
#line 1562 "threads.c"
#line 1348 "threads.xs"
        PERL_UNUSED_VAR(items);
...
XS_EUPXS(XS_threads_kill)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1392 "threads.xs"
        ithread *thread;
        char *sig_name;
        IV signal;
        int no_handler = 1;
#line 1620 "threads.c"
#line 1397 "threads.xs"
...
XS_EUPXS(XS_threads_equal)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1455 "threads.xs"
        int are_equal = 0;
#line 1697 "threads.c"
#line 1457 "threads.xs"
        PERL_UNUSED_VAR(items);
...
XS_EUPXS(XS_threads__handle)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1542 "threads.xs"
        ithread *thread;
#line 1802 "threads.c"
#line 1544 "threads.xs"
        PERL_UNUSED_VAR(items);
        thread = S_SV_to_ithread(aTHX_ ST(0));
#ifdef WIN32
...
XS_EUPXS(XS_threads_get_stack_size)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1557 "threads.xs"
        IV stack_size;
        dMY_POOL;
#line 1827 "threads.c"
#line 1560 "threads.xs"
        PERL_UNUSED_VAR(items);
        if (sv_isobject(ST(0))) {
            /* $thr->get_stack_size() */
...
XS_EUPXS(XS_threads_set_stack_size)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1576 "threads.xs"
        IV old_size;
        dMY_POOL;
#line 1855 "threads.c"
#line 1579 "threads.xs"
        if (items != 2) {
...
XS_EUPXS(XS_threads_is_running)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1598 "threads.xs"
        ithread *thread;
#line 1885 "threads.c"
#line 1600 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
...
XS_EUPXS(XS_threads_is_detached)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1615 "threads.xs"
        ithread *thread;
#line 1911 "threads.c"
#line 1617 "threads.xs"
        PERL_UNUSED_VAR(items);
        thread = S_SV_to_ithread(aTHX_ ST(0));
        MUTEX_LOCK(&thread->mutex);
...
XS_EUPXS(XS_threads_is_joinable)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1628 "threads.xs"
        ithread *thread;
#line 1933 "threads.c"
#line 1630 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
...
XS_EUPXS(XS_threads_wantarray)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1647 "threads.xs"
        ithread *thread;
#line 1961 "threads.c"
#line 1649 "threads.xs"
        PERL_UNUSED_VAR(items);
        thread = S_SV_to_ithread(aTHX_ ST(0));
...
XS_EUPXS(XS_threads_set_thread_exit_only)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1660 "threads.xs"
        ithread *thread;
#line 1983 "threads.c"
#line 1662 "threads.xs"
        if (items != 2) {
