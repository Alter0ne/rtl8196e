...
case "$perladmin" in
'') perladmin='alter0ne@alter0ne-pc.(none)' ;;
esac
...
'') if test "/home/alter0ne/rtk_openwrt_sdk/staging_dir/host/usr" = ".../.."; then
	installprefix="$prefix"
    else
	installprefix='/home/alter0ne/rtk_openwrt_sdk/staging_dir/host/usr'
    fi
    ;;
esac
...
#     /home/alter0ne/rtk_openwrt_sdk/staging_dir/host/usr, so it isn't included here either.
#
...
bin='.../'
# scriptdir='.../'
# privlib='.../../lib/perl5/5.20.0'
# archlib='.../../lib/perl5/5.20.0/x86_64-linux'
# man1dir='.../../man/man1'
# man3dir='.../../man/man3'
# man1ext='1'
# man3ext='3'
...
# sitebin='.../../bin'
# sitescript='.../../bin'
# sitelib='.../../lib/perl5/site_perl/5.20.0'
# sitearch='.../../lib/perl5/site_perl/5.20.0/x86_64-linux'
