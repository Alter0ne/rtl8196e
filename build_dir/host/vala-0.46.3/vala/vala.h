...
ValaDataType* vala_semantic_analyzer_get_this_type (ValaMethod* m);
...
#define VALA_MINOR_VERSION 46
#define VALA_MICRO_VERSION 3
#define VALA_API_VERSION "0.46"
#define VALA_BUILD_VERSION "0.46.3"
