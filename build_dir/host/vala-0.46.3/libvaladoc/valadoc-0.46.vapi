/* valadoc-0.46.vapi generated by valac, do not modify. */

namespace Valadoc {
	namespace Api {
		[CCode (cheader_filename = "valadoc.h")]
		public class Array : Valadoc.Api.Item {
			public Array (Valadoc.Api.Item parent, Vala.ArrayType data);
		...
		public class Attribute : Valadoc.Api.Item {
			public Attribute (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.Attribute data);
			protected override Valadoc.Content.Inline build_signature ();
		...
		public class Class : Valadoc.Api.TypeSymbol {
			public Class (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, Vala.Class data);
		...
		[CCode (cheader_filename = "valadoc.h")]
		public class Constant : Valadoc.Api.Symbol {
			public Constant (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, Vala.Constant data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string get_cname ();
		...
		public class Delegate : Valadoc.Api.TypeSymbol, Valadoc.Api.Callable {
			public Delegate (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, Vala.Delegate data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
		...
		public class Enum : Valadoc.Api.TypeSymbol {
			public Enum (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, Vala.Enum data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
			public string? get_type_id ();
		...
		public class EnumValue : Valadoc.Api.Symbol {
			public EnumValue (Valadoc.Api.Enum parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SourceComment? comment, Vala.EnumValue data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string get_cname ();
		...
		public class ErrorCode : Valadoc.Api.Symbol {
			public ErrorCode (Valadoc.Api.ErrorDomain parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SourceComment? comment, Vala.ErrorCode data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string get_cname ();
			public string get_dbus_name ();
		...
		public class ErrorDomain : Valadoc.Api.TypeSymbol {
			public ErrorDomain (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, Vala.ErrorDomain data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
			public string? get_dbus_name ();
		...
		[CCode (cheader_filename = "valadoc.h")]
		public class Field : Valadoc.Api.Symbol {
			public Field (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, Vala.Field data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
		...
		public class FormalParameter : Valadoc.Api.Symbol {
			public FormalParameter (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string? name, Vala.SymbolAccessibility accessibility, Vala.ParameterDirection type, bool ellipsis, Vala.Parameter data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public Valadoc.Content.Run default_value { get; set; }
		...
		public class Interface : Valadoc.Api.TypeSymbol {
			public Interface (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, Vala.Interface data);
			public override void accept (Valadoc.Api.Visitor visitor);
			public void add_interface (Valadoc.Api.TypeReference iface);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
		...
		public abstract class Item : GLib.Object {
			...
			public Vala.CodeNode? data { get; private set; }
			public Valadoc.Api.Item parent { get; protected set; }
			public Valadoc.Content.Inline signature { get; }
		}
		[CCode (cheader_filename = "valadoc.h")]
		public class Method : Valadoc.Api.Symbol, Valadoc.Api.Callable {
			public Method (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, Vala.Method data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
			public string get_dbus_name ();
			...
			public weak Valadoc.Api.Method? base_method { get; set; }
		...
		public class Namespace : Valadoc.Api.Symbol {
			public Namespace (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string? name, Valadoc.Api.SourceComment? comment, Vala.Namespace data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
		...
		[CCode (cheader_filename = "valadoc.h")]
		public abstract class Node : Valadoc.Api.Item, Valadoc.Documentation {
			protected bool do_document;
			protected Node (Valadoc.Api.Node? parent, Valadoc.Api.SourceFile? file, string? name, Vala.CodeNode? data);
		...
		public class Pointer : Valadoc.Api.Item {
			public Pointer (Valadoc.Api.Item parent, Vala.PointerType data);
			protected override Valadoc.Content.Inline build_signature ();
			public Valadoc.Api.Item data_type { get; set; }
		}
		[CCode (cheader_filename = "valadoc.h")]
		public class Property : Valadoc.Api.Symbol {
			public Property (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, Vala.Property data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
			public string get_dbus_name ();
		...
		public class PropertyAccessor : Valadoc.Api.Symbol {
			public PropertyAccessor (Valadoc.Api.Property parent, Valadoc.Api.SourceFile file, string name, Vala.SymbolAccessibility accessibility, Vala.PropertyAccessor data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
		...
		[CCode (cheader_filename = "valadoc.h")]
		public class Signal : Valadoc.Api.Symbol, Valadoc.Api.Callable {
			public Signal (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, Vala.Signal data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
			public string get_dbus_name ();
		...
		public class SignatureBuilder {
			...
			public unowned Valadoc.Api.SignatureBuilder append (string text, bool spaced = true);
			public unowned Valadoc.Api.SignatureBuilder append_attribute (string text, bool spaced = true);
			public unowned Valadoc.Api.SignatureBuilder append_content (Valadoc.Content.Inline content, bool spaced = true);
			public unowned Valadoc.Api.SignatureBuilder append_highlighted (string text, bool spaced = true);
			public unowned Valadoc.Api.SignatureBuilder append_keyword (string keyword, bool spaced = true);
			public unowned Valadoc.Api.SignatureBuilder append_literal (string literal, bool spaced = true);
			public unowned Valadoc.Api.SignatureBuilder append_symbol (Valadoc.Api.Node node, bool spaced = true);
			public unowned Valadoc.Api.SignatureBuilder append_type (Valadoc.Api.Node node, bool spaced = true);
			public unowned Valadoc.Api.SignatureBuilder append_type_name (string name, bool spaced = true);
		...
		public class SourceFile : GLib.Object {
			public SourceFile (Valadoc.Api.Package package, string relative_path, string? relative_c_path, Vala.SourceFile? data);
			public string get_name ();
			public Vala.SourceFile? data { get; private set; }
		...
		public class Struct : Valadoc.Api.TypeSymbol {
			public Struct (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, Vala.Struct data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
		...
		public abstract class Symbol : Valadoc.Api.Node {
			protected Symbol (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string? name, Vala.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, Vala.Symbol data);
			...
			public override bool is_browsable (Valadoc.Settings settings);
			public Vala.SymbolAccessibility accessibility { get; private set; }
		...
		[CCode (cheader_filename = "valadoc.h")]
		public class Tree {
			public Tree (Valadoc.ErrorReporter reporter, Valadoc.Settings settings, Vala.CodeContext context);
		...
		public class TypeParameter : Valadoc.Api.Symbol {
			public TypeParameter (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.TypeParameter data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public override bool is_browsable (Valadoc.Settings settings);
			public override Valadoc.Api.NodeType node_type { get; }
		...
		public class TypeReference : Valadoc.Api.Item {
			public TypeReference (Valadoc.Api.Item parent, bool is_dynamic, bool is_nullable, string? dbus_type_signature, Vala.DataType? data);
		...
		public abstract class TypeSymbol : Valadoc.Api.Symbol {
			protected TypeSymbol (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Vala.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, bool is_basic_type, Vala.TypeSymbol data);
	...
	namespace Devhelp {
		...
		public class MarkupWriter : Valadoc.MarkupWriter {
			...
			public unowned Valadoc.Devhelp.MarkupWriter end_book ();
			public unowned Valadoc.Devhelp.MarkupWriter end_chapters ();
			public unowned Valadoc.Devhelp.MarkupWriter end_functions ();
			public unowned Valadoc.Devhelp.MarkupWriter end_sub ();
			protected override bool inline_element (string name);
			public unowned Valadoc.Devhelp.MarkupWriter keyword (string name, string type, string link);
			public unowned Valadoc.Devhelp.MarkupWriter start_book (string title, string lang, string link, string name, string version, string author);
			public unowned Valadoc.Devhelp.MarkupWriter start_chapters ();
			public unowned Valadoc.Devhelp.MarkupWriter start_functions ();
			public unowned Valadoc.Devhelp.MarkupWriter start_sub (string name, string link);
		}
	}
	namespace Gtkdoc {
		[CCode (cheader_filename = "valadoc.h")]
	...
	namespace Html {
		...
		public class MarkupWriter : Valadoc.MarkupWriter {
			...
			public unowned Valadoc.Html.MarkupWriter add_usemap (Valadoc.Charts.Chart chart);
			public MarkupWriter.builder (GLib.StringBuilder builder, bool html5_declaration = true);
			protected override bool content_inline_element (string name);
			public unowned Valadoc.Html.MarkupWriter image (string src, string? caption = null, string? css_class = null);
			protected override bool inline_element (string name);
			public unowned Valadoc.Html.MarkupWriter javascript_link (string url);
			public unowned Valadoc.Html.MarkupWriter link (string url, string label, string? css_class = null);
			public unowned Valadoc.Html.MarkupWriter stylesheet_link (string url);
		}
		[CCode (cheader_filename = "valadoc.h")]
	...
	namespace Importer {
		...
		public abstract class DocumentationImporter : GLib.Object, Valadoc.ResourceLocator {
			...
			protected Valadoc.Settings settings;
			protected Valadoc.Api.Tree tree;
			protected DocumentationImporter (Valadoc.Api.Tree tree, Valadoc.ModuleLoader modules, Valadoc.Settings settings);
	...
	namespace Taglets {
		...
		public class Param : Valadoc.Content.BlockContent, Valadoc.Content.Taglet, Valadoc.Content.Block {
			...
			public weak Valadoc.Api.Symbol? parameter { get; private set; }
	...
	public class ErrorReporter : GLib.Object {
		...
		public weak GLib.FileStream stream { get; set; }
	...
	public class GtkDocMarkupWriter : Valadoc.MarkupWriter {
		...
		protected override bool inline_element (string name);
		public void reset ();
		public weak string content { get; }
	}
	[CCode (cheader_filename = "valadoc.h")]
	...
	public class MarkupWriter {
		...
		public unowned Valadoc.MarkupWriter end_tag (string name);
		public static string escape (string txt);
		protected virtual bool inline_element (string name);
		public unowned Valadoc.MarkupWriter raw_text (string text);
		public void set_wrap (bool wrap);
		public unowned Valadoc.MarkupWriter simple_tag (string name, string[]? attributes = null);
		public unowned Valadoc.MarkupWriter start_tag (string name, string[]? attributes = null);
		public unowned Valadoc.MarkupWriter text (string text);
	}
	[CCode (cheader_filename = "valadoc.h")]
