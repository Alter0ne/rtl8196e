...
Enc34@input = element(11, Val),
if Enc34@input =:= asn1_NOVALUE ->
[];
Enc34@input bsr 16 =:= 0 ->
[align|<<2:8,Enc34@input:16>>];
true ->
exit({error,{asn1,{illegal_value,Enc34@input}}})
end
end].
...
[];
true ->
enc_SignalsDescriptor(Enc11@input)
end
end,
Extensions,
begin
...
true ->
begin
Enc14@output = enc_NotifyBehaviour(Enc13@input),
Enc15@bin = complete(Enc14@output),
...
[];
true ->
enc_SecondEventsDescriptor(Enc12@input)
end
end,
begin
Enc14@input = element(5, Val),
...
[];
true ->
enc_SignalsDescriptor(Enc14@input)
end
end,
Extensions,
begin
...
true ->
begin
Enc17@output = enc_NotifyBehaviour(Enc16@input),
Enc18@bin = complete(Enc17@output),
...
[];
true ->
enc_SecondEventsDescriptor(Enc4@input)
end
end|begin
Enc6@input = element(3, Val),
if Enc6@input =:= asn1_NOVALUE ->
[];
true ->
enc_SignalsDescriptor(Enc6@input)
end
end].
...
true ->
begin
Enc11@output = if Enc9@input bsr 32 =:= 0 ->
begin
...
[<<Enc9@input@bin_size:2,0:6>>|Enc9@input@bin]
end;
true ->
exit({error,{asn1,{illegal_value,Enc9@input}}})
end,
Enc12@bin = complete(Enc11@output),
...
begin
Enc5@input = element(2, Val),
enc_IndAudTerminationStateDescriptor_propertyParms(Enc5@input)
end,
begin
Enc6@input = element(3, Val),
if Enc6@input =:= asn1_NOVALUE ->
...
true ->
begin
Enc6@output = enc_PropertyParm(Enc5@input),
...
[];
true ->
enc_IndAudLocalControlDescriptor_propertyParms(Enc13@input)
end
end,
Extensions|begin
...
[];
Enc15@input =:= sendOnly ->
[align|<<1:8,0:1,0:3,0:4>>];
Enc15@input =:= recvOnly ->
[align|<<1:8,0:1,1:3,0:4>>];
Enc15@input =:= sendRecv ->
[align|<<1:8,0:1,2:3,0:4>>];
Enc15@input =:= inactive ->
[align|<<1:8,0:1,3:3,0:4>>];
Enc15@input =:= loopBack ->
[align|<<1:8,0:1,4:3,0:4>>];
true ->
...
Enc3@input = element(3, Val),
enc_TerminationAudit(Enc3@input)
end].
...
true ->
begin
Enc6@output = enc_TerminationIDList(Enc5@input),
Enc7@bin = complete(Enc6@output),
Enc7@len = byte_size(Enc7@bin),
if Enc7@len < 128 ->
[align,
...
if Enc10@input =:= asn1_NOVALUE ->
[];
Enc10@input =:= onewayexternal ->
[align|<<1:8,0:1,0:1,0:6>>];
Enc10@input =:= onewayboth ->
[align|<<1:8,0:1,1:1,0:6>>];
true ->
exit({error,{asn1,{illegal_value,Enc10@input}}})
end
end].
...
[];
Enc18@input bsr 4 =:= 0 ->
[align|<<1:8,Enc18@input:4,0:4>>];
true ->
exit({error,{asn1,{illegal_value,Enc18@input}}})
end
end,
begin
...
true ->
begin
Enc28@output = enc_SelectLogic(Enc27@input),
...
true ->
begin
Enc22@output = enc_ContextRequest_contextList(Enc21@input),
Enc23@bin = complete(Enc22@output),
