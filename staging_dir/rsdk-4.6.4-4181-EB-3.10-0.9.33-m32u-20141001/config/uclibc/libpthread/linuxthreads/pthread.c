...
#endif
	.ptr_fork_to_pthread_fork = fork_to_pthread_fork,
...
# if !defined __UCLIBC_HAS_TLS__ && defined __UCLIBC_HAS_RESOLVER_SUPPORT__
...
pthread_t attribute_protected __pthread_self(void)
{
  pthread_descr self = thread_self();
...
int attribute_protected __pthread_equal(pthread_t thread1, pthread_t thread2)
{
...
int attribute_protected __pthread_setschedparam(pthread_t thread, int policy,
...
int attribute_protected __pthread_getschedparam(pthread_t thread, int *policy,
