...
int attribute_protected __pthread_mutex_init(pthread_mutex_t * mutex,
...
int attribute_protected __pthread_mutex_destroy(pthread_mutex_t * mutex)
{
...
int attribute_protected __pthread_mutex_trylock(pthread_mutex_t * mutex)
{
  pthread_descr self;
  int retcode;
...
int attribute_protected __pthread_mutex_lock(pthread_mutex_t * mutex)
{
  pthread_descr self;
...
int attribute_protected __pthread_mutex_unlock(pthread_mutex_t * mutex)
{
  switch (mutex->__m_kind) {
  case PTHREAD_MUTEX_ADAPTIVE_NP:
...
int attribute_protected __pthread_once(pthread_once_t * once_control, void (*init_routine)(void))
{
