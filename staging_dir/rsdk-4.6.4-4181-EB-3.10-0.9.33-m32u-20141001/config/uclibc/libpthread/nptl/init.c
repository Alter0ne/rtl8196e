...
sighandler_setxid (int sig, siginfo_t *si, void *ctx)
{
  ...
  cntr = (int *) &__xidcmd->cntr;
  if (atomic_decrement_val (cntr) == 0)
...
__pthread_initialize_minimal_internal (void)
{
  ...
  int res __attribute__((unused)) = INTERNAL_SYSCALL (set_robust_list, err, 2, &pd->robust_head,
