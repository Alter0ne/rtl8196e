...
#define MASK_FP_EXCEPTIONS (1 << 8)
#define MASK_FLOAT64 (1 << 9)
#define MASK_FUSED_MADD (1 << 10)
#define MASK_64BIT (1 << 11)
#define MASK_MIPS16 (1 << 12)
#define MASK_MIPS3D (1 << 13)
#define MASK_LLSC (1 << 14)
#define MASK_LONG64 (1 << 15)
#define MASK_MAC (1 << 16)
#define MASK_MEMCPY (1 << 17)
#define MASK_PAIRED_SINGLE_FLOAT (1 << 18)
#define MASK_RADIAX (1 << 19)
#define MASK_RELAX_PIC_CALLS (1 << 20)
#define MASK_SAVE_RESTORE_MMD (1 << 21)
#define MASK_SIMD (1 << 22)
#define MASK_SINGLE_FLOAT (1 << 23)
#define MASK_SMARTMIPS (1 << 24)
#define MASK_SOFT_FLOAT_ABI (1 << 25)
#define MASK_SPLIT_ADDRESSES (1 << 26)
#define MASK_SYNCI (1 << 27)
#define MASK_UNSAFE_ZERO_OVERHEAD (1 << 28)
#define MASK_ZERO_OVERHEAD (1 << 29)
...
enum opt_code
{
  ...
  OPT_Wmissing_delay_slot = 262,             /* -Wmissing-delay-slot */
  OPT_Wmissing_field_initializers = 263,     /* -Wmissing-field-initializers */
  OPT_Wmissing_format_attribute = 264,       /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 265,           /* -Wmissing-include-dirs */
  OPT_Wmissing_noreturn = 266,               /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 267,         /* -Wmissing-parameter-type */
  OPT_Wmissing_prototypes = 268,             /* -Wmissing-prototypes */
  OPT_Wmudflap = 269,                        /* -Wmudflap */
  OPT_Wmultichar = 270,                      /* -Wmultichar */
  OPT_Wnested_externs = 271,                 /* -Wnested-externs */
  OPT_Wnls = 272,                            /* -Wnls */
  OPT_Wno_effect_assign = 273,               /* -Wno-effect-assign */
  OPT_Wnoexcept = 274,                       /* -Wnoexcept */
  OPT_Wnon_template_friend = 275,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 276,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 277,                        /* -Wnonnull */
  OPT_Wnormalized_ = 278,                    /* -Wnormalized= */
  OPT_Wnull = 279,                           /* -Wnull */
  OPT_Wold_style_cast = 280,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 281,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 282,           /* -Wold-style-definition */
  OPT_Wout_of_date = 283,                    /* -Wout-of-date */
  OPT_Wover_ann = 284,                       /* -Wover-ann */
  OPT_Woverflow = 285,                       /* -Woverflow */
  OPT_Woverlength_strings = 286,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 287,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 288,                  /* -Woverride-init */
  OPT_Wp_ = 289,                             /* -Wp, */
  OPT_Wpacked = 290,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 291,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 292,                         /* -Wpadded */
  OPT_Wparam_assign = 293,                   /* -Wparam-assign */
  OPT_Wparentheses = 294,                    /* -Wparentheses */
  OPT_Wpkg_default_method = 295,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 296,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 297,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 298,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 299,            /* -Wpointer-to-int-cast */
  OPT_Wpossible_load_use = 300,              /* -Wpossible-load-use */
  OPT_Wpragmas = 301,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 302,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 303,                       /* -Wprotocol */
  OPT_Wpsabi = 304,                          /* -Wpsabi */
  OPT_Wraw = 305,                            /* -Wraw */
  OPT_Wreal_q_constant = 306,                /* -Wreal-q-constant */
  OPT_Wredundant_decls = 307,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 308,            /* -Wredundant-modifiers */
  OPT_Wreorder = 309,                        /* -Wreorder */
  OPT_Wreturn_type = 310,                    /* -Wreturn-type */
  OPT_Wselector = 311,                       /* -Wselector */
  OPT_Wsequence_point = 312,                 /* -Wsequence-point */
  OPT_Wserial = 313,                         /* -Wserial */
  OPT_Wshadow = 314,                         /* -Wshadow */
  OPT_Wsign_compare = 315,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 316,                /* -Wsign-conversion */
  OPT_Wsign_promo = 317,                     /* -Wsign-promo */
  OPT_Wspecial_param_hiding = 318,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 319,                /* -Wstack-protector */
  OPT_Wstatic_access = 320,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 321,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 322,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 323,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 324,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 325,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 326,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 327,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 328,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 329,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_noreturn = 330,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 331,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 332,                       /* -Wsuppress */
  OPT_Wsurprising = 333,                     /* -Wsurprising */
  OPT_Wswitch = 334,                         /* -Wswitch */
  OPT_Wswitch_default = 335,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 336,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 337,                      /* -Wsync-nand */
  OPT_Wsynth = 338,                          /* -Wsynth */
  OPT_Wsynthetic_access = 339,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 340,                 /* -Wsystem-headers */
  OPT_Wtabs = 341,                           /* -Wtabs */
  OPT_Wtasks = 342,                          /* -Wtasks */
  OPT_Wtraditional = 343,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 344,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 345,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 346,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 347,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 348,                    /* -Wtype-limits */
  OPT_Wuncheck = 349,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 350,            /* -Wundeclared-selector */
  OPT_Wundef = 351,                          /* -Wundef */
  OPT_Wunderflow = 352,                      /* -Wunderflow */
  OPT_Wuninitialized = 353,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 354,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 355,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 356,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 357, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 358,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 359,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 360,                         /* -Wunused */
  OPT_Wunused_argument = 361,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 362,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 363,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 364,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 365,                /* -Wunused-function */
  OPT_Wunused_import = 366,                  /* -Wunused-import */
  OPT_Wunused_label = 367,                   /* -Wunused-label */
  OPT_Wunused_local = 368,                   /* -Wunused-local */
  OPT_Wunused_macros = 369,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 370,               /* -Wunused-parameter */
  OPT_Wunused_private = 371,                 /* -Wunused-private */
  OPT_Wunused_result = 372,                  /* -Wunused-result */
  OPT_Wunused_thrown = 373,                  /* -Wunused-thrown */
  OPT_Wunused_value = 374,                   /* -Wunused-value */
  OPT_Wunused_variable = 375,                /* -Wunused-variable */
  OPT_Wuseless_type_check = 376,             /* -Wuseless-type-check */
  OPT_Wvarargs_cast = 377,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 378,                /* -Wvariadic-macros */
  OPT_Wvla = 379,                            /* -Wvla */
  OPT_Wvolatile_register_var = 380,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 381,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 382,                  /* -Wwrite-strings */
  OPT_Xassembler = 383,                      /* -Xassembler */
  OPT_Xlinker = 384,                         /* -Xlinker */
  OPT_Xpreprocessor = 385,                   /* -Xpreprocessor */
  OPT_Z = 386,                               /* -Z */
  OPT_ansi = 387,                            /* -ansi */
  OPT_aux_info = 388,                        /* -aux-info */
  /* OPT_aux_info_ = 389, */                 /* -aux-info= */
  OPT_auxbase = 390,                         /* -auxbase */
  OPT_auxbase_strip = 391,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 392, */             /* -bootclasspath */
  OPT_c = 393,                               /* -c */
  /* OPT_classpath = 394, */                 /* -classpath */
  OPT_coverage = 395,                        /* -coverage */
  OPT_cpp = 396,                             /* -cpp */
  OPT_cpp_ = 397,                            /* -cpp= */
  OPT_d = 398,                               /* -d */
  OPT_dumpbase = 399,                        /* -dumpbase */
  OPT_dumpdir = 400,                         /* -dumpdir */
  OPT_dumpmachine = 401,                     /* -dumpmachine */
  OPT_dumpspecs = 402,                       /* -dumpspecs */
  OPT_dumpversion = 403,                     /* -dumpversion */
  OPT_e = 404,                               /* -e */
  /* OPT_encoding = 405, */                  /* -encoding */
  OPT_export_dynamic = 406,                  /* -export-dynamic */
  OPT_extdirs = 407,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 408, */               /* -fCLASSPATH= */
  OPT_fPIC = 409,                            /* -fPIC */
  OPT_fPIE = 410,                            /* -fPIE */
  OPT_fRTS_ = 411,                           /* -fRTS= */
  OPT_fabi_version_ = 412,                   /* -fabi-version= */
  OPT_faccess_control = 413,                 /* -faccess-control */
  OPT_falign_commons = 414,                  /* -falign-commons */
  OPT_falign_functions = 415,                /* -falign-functions */
  OPT_falign_functions_ = 416,               /* -falign-functions= */
  OPT_falign_jumps = 417,                    /* -falign-jumps */
  OPT_falign_jumps_ = 418,                   /* -falign-jumps= */
  OPT_falign_labels = 419,                   /* -falign-labels */
  OPT_falign_labels_ = 420,                  /* -falign-labels= */
  OPT_falign_loops = 421,                    /* -falign-loops */
  OPT_falign_loops_ = 422,                   /* -falign-loops= */
  OPT_fall_intrinsics = 423,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 424, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 425,       /* -fallow-leading-underscore */
  /* OPT_falt_external_templates = 426, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 427, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 428, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 429, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 430, */  /* -fargument-noalias-global */
  OPT_fasm = 431,                            /* -fasm */
  OPT_fassert = 432,                         /* -fassert */
  OPT_fassociative_math = 433,               /* -fassociative-math */
  OPT_fassume_compiled = 434,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 435,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 436,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 437,                   /* -fauto-inc-dec */
  OPT_fautomatic = 438,                      /* -fautomatic */
  OPT_faux_classpath = 439,                  /* -faux-classpath */
  OPT_fbackslash = 440,                      /* -fbackslash */
  OPT_fbacktrace = 441,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 442,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 443,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 444,              /* -fbootstrap-classes */
  OPT_fbounds_check = 445,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 446,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 447,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 448,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 449,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 450,               /* -fbtr-bb-exclusive */
  OPT_fbuiltin = 451,                        /* -fbuiltin */
  OPT_fbuiltin_ = 452,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 453,                    /* -fcall-saved- */
  OPT_fcall_used_ = 454,                     /* -fcall-used- */
  OPT_fcaller_saves = 455,                   /* -fcaller-saves */
  OPT_fcheck_array_temporaries = 456,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 457,                /* -fcheck-data-deps */
  OPT_fcheck_new = 458,                      /* -fcheck-new */
  OPT_fcheck_references = 459,               /* -fcheck-references */
  OPT_fcheck_ = 460,                         /* -fcheck= */
  OPT_fclasspath_ = 461,                     /* -fclasspath= */
  OPT_fcoarray_ = 462,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 463,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 464,                         /* -fcommon */
  OPT_fcompare_debug = 465,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 466,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 467,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 468,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 469,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 470,                  /* -fcond-mismatch */
  OPT_fconserve_space = 471,                 /* -fconserve-space */
  OPT_fconserve_stack = 472,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 473,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 474,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 475,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 476,          /* -fconvert=little-endian */
  OPT_fconvert_native = 477,                 /* -fconvert=native */
  OPT_fconvert_swap = 478,                   /* -fconvert=swap */
  OPT_fcprop_registers = 479,                /* -fcprop-registers */
  OPT_fcray_pointer = 480,                   /* -fcray-pointer */
  OPT_fcrossjumping = 481,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 482,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 483, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 484,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 485,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 486,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 487,            /* -fd-lines-as-comments */
  OPT_fdafile_relative = 488,                /* -fdafile-relative */
  OPT_fdata_sections = 489,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 490,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 491,                       /* -fdbg-cnt= */
  OPT_fdce = 492,                            /* -fdce */
  OPT_fdebug_prefix_map_ = 493,              /* -fdebug-prefix-map= */
  OPT_fdeduce_init_list = 494,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 495,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 496, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 497,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 498,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 499,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 500,                 /* -fdelayed-branch */
  OPT_fdelete_null_pointer_checks = 501,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 502,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_location_ = 503,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 504,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 505,                /* -fdirectives-only */
  OPT_fdisable_assertions = 506,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 507,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 508,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 509,         /* -fdollars-in-identifiers */
  OPT_fdse = 510,                            /* -fdse */
  OPT_fdump_ = 511,                          /* -fdump- */
  OPT_fdump_core = 512,                      /* -fdump-core */
  OPT_fdump_final_insns = 513,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 514,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 515,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 516,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 517,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 518,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 519,                /* -fdump-parse-tree */
  OPT_fdump_unnumbered = 520,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 521,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 522,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 523,                 /* -fearly-inlining */
  OPT_felide_constructors = 524,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 525,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 526, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 527,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 528,        /* -femit-class-debug-always */
  OPT_femit_class_file = 529,                /* -femit-class-file */
  OPT_femit_class_files = 530,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 531,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 532,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 533,      /* -femit-struct-debug-reduced */
  OPT_fenable_assertions = 534,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 535,             /* -fenable-assertions= */
  OPT_fenable_icf_debug = 536,               /* -fenable-icf-debug */
  OPT_fencoding_ = 537,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 538,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 539, */           /* -fenum-int-equiv */
  OPT_fexceptions = 540,                     /* -fexceptions */
  OPT_fexcess_precision_ = 541,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 542,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 543,        /* -fexpensive-optimizations */
  OPT_fextdirs_ = 544,                       /* -fextdirs= */
  OPT_fextended_identifiers = 545,           /* -fextended-identifiers */
  OPT_fexternal_blas = 546,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 547, */       /* -fexternal-templates */
  OPT_ff2c = 548,                            /* -ff2c */
  OPT_ffast_math = 549,                      /* -ffast-math */
  OPT_ffilelist_file = 550,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 551,               /* -ffinite-math-only */
  OPT_ffix_bdsl = 552,                       /* -ffix-bdsl */
  OPT_ffixed_ = 553,                         /* -ffixed- */
  OPT_ffixed_form = 554,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 555,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 556,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 557,                    /* -ffloat-store */
  OPT_ffor_scope = 558,                      /* -ffor-scope */
  /* OPT_fforce_addr = 559, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 560,    /* -fforce-classes-archive-check */
  OPT_fforce_conv = 561,                     /* -fforce-conv */
  OPT_fforward_propagate = 562,              /* -fforward-propagate */
  OPT_ffp_contract_ = 563,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 564,                      /* -ffpe-trap= */
  OPT_ffree_form = 565,                      /* -ffree-form */
  OPT_ffree_line_length_ = 566,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 567,          /* -ffree-line-length-none */
  OPT_ffreestanding = 568,                   /* -ffreestanding */
  OPT_ffriend_injection = 569,               /* -ffriend-injection */
  OPT_ffunction_cse = 570,                   /* -ffunction-cse */
  OPT_ffunction_sections = 571,              /* -ffunction-sections */
  OPT_fgcse = 572,                           /* -fgcse */
  OPT_fgcse_after_reload = 573,              /* -fgcse-after-reload */
  OPT_fgcse_las = 574,                       /* -fgcse-las */
  OPT_fgcse_lm = 575,                        /* -fgcse-lm */
  OPT_fgcse_sm = 576,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 577,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 578,                    /* -fgnu-runtime */
  OPT_fgnu89_inline = 579,                   /* -fgnu89-inline */
  OPT_fgo_dump_ = 580,                       /* -fgo-dump- */
  OPT_fgo_prefix_ = 581,                     /* -fgo-prefix= */
  OPT_fgraphite = 582,                       /* -fgraphite */
  OPT_fgraphite_identity = 583,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 584,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 585, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 586, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 587,           /* -fhash-synchronization */
  /* OPT_fhelp = 588, */                     /* -fhelp */
  /* OPT_fhelp_ = 589, */                    /* -fhelp= */
  /* OPT_fhonor_std = 590, */                /* -fhonor-std */
  OPT_fhosted = 591,                         /* -fhosted */
  /* OPT_fhuge_objects = 592, */             /* -fhuge-objects */
  OPT_fident = 593,                          /* -fident */
  OPT_fif_conversion = 594,                  /* -fif-conversion */
  OPT_fif_conversion2 = 595,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 596,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 597,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 598,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 599,             /* -fimplicit-templates */
  OPT_findirect_classes = 600,               /* -findirect-classes */
  OPT_findirect_dispatch = 601,              /* -findirect-dispatch */
  OPT_findirect_inlining = 602,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 603,         /* -finhibit-size-directive */
  OPT_finit_character_ = 604,                /* -finit-character= */
  OPT_finit_integer_ = 605,                  /* -finit-integer= */
  OPT_finit_local_zero = 606,                /* -finit-local-zero */
  OPT_finit_logical_ = 607,                  /* -finit-logical= */
  OPT_finit_real_ = 608,                     /* -finit-real= */
  OPT_finline = 609,                         /* -finline */
  OPT_finline_functions = 610,               /* -finline-functions */
  OPT_finline_functions_called_once = 611,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 612, */            /* -finline-limit- */
  OPT_finline_limit_ = 613,                  /* -finline-limit= */
  OPT_finline_small_functions = 614,         /* -finline-small-functions */
  OPT_finput_charset_ = 615,                 /* -finput-charset= */
  OPT_finstrument_functions = 616,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 617,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 618,/* -finstrument-functions-exclude-function-list= */
  OPT_fintrinsic_modules_path = 619,         /* -fintrinsic-modules-path */
  OPT_fipa_cp = 620,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 621,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 622,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 623,                    /* -fipa-profile */
  OPT_fipa_pta = 624,                        /* -fipa-pta */
  OPT_fipa_pure_const = 625,                 /* -fipa-pure-const */
  OPT_fipa_reference = 626,                  /* -fipa-reference */
  OPT_fipa_sra = 627,                        /* -fipa-sra */
  OPT_fipa_struct_reorg = 628,               /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 629,                 /* -fira-algorithm= */
  OPT_fira_loop_pressure = 630,              /* -fira-loop-pressure */
  OPT_fira_region_ = 631,                    /* -fira-region= */
  OPT_fira_share_save_slots = 632,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 633,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 634,                   /* -fira-verbose= */
  OPT_fivopts = 635,                         /* -fivopts */
  OPT_fjni = 636,                            /* -fjni */
  OPT_fjump_tables = 637,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 638,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 639,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 640,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 641, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 642,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 643,             /* -fleading-underscore */
  OPT_floop_block = 644,                     /* -floop-block */
  OPT_floop_flatten = 645,                   /* -floop-flatten */
  OPT_floop_interchange = 646,               /* -floop-interchange */
  /* OPT_floop_optimize = 647, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 648,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 649,                /* -floop-strip-mine */
  OPT_flto = 650,                            /* -flto */
  OPT_flto_compression_level_ = 651,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 652,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 653,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 654,             /* -flto-partition=none */
  OPT_flto_report = 655,                     /* -flto-report */
  OPT_flto_ = 656,                           /* -flto= */
  OPT_fltrans = 657,                         /* -fltrans */
  OPT_fltrans_output_list_ = 658,            /* -fltrans-output-list= */
  OPT_fmain_ = 659,                          /* -fmain= */
  OPT_fmath_errno = 660,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 661,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 662,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 663,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 664,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 665,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 666,                     /* -fmem-report */
  OPT_fmerge_all_constants = 667,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 668,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 669,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 670,                /* -fmessage-length= */
  OPT_fmodule_private = 671,                 /* -fmodule-private */
  OPT_fmodulo_sched = 672,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 673,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 674,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 675,                  /* -fms-extensions */
  OPT_fmudflap = 676,                        /* -fmudflap */
  OPT_fmudflapir = 677,                      /* -fmudflapir */
  OPT_fmudflapth = 678,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 679, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 680, */                  /* -fnew-abi */
  OPT_fnext_runtime = 681,                   /* -fnext-runtime */
  OPT_fnil_receivers = 682,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 683,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 684,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 685, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 686,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 687,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 688,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 689,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 690,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 691,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 692,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 693,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 694,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 695,             /* -fomit-frame-pointer */
  OPT_fopenmp = 696,                         /* -fopenmp */
  OPT_foperator_names = 697,                 /* -foperator-names */
  OPT_foptimize_register_move = 698,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 699,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 700,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 701, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 702,              /* -foutput-class-dir= */
  OPT_fpack_derived = 703,                   /* -fpack-derived */
  OPT_fpack_struct = 704,                    /* -fpack-struct */
  OPT_fpack_struct_ = 705,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 706,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 707,              /* -fpcc-struct-return */
  OPT_fpch_deps = 708,                       /* -fpch-deps */
  OPT_fpch_preprocess = 709,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 710,                     /* -fpeel-loops */
  OPT_fpeephole = 711,                       /* -fpeephole */
  OPT_fpeephole2 = 712,                      /* -fpeephole2 */
  OPT_fpermissive = 713,                     /* -fpermissive */
  OPT_fpic = 714,                            /* -fpic */
  OPT_fpie = 715,                            /* -fpie */
  OPT_fplan9_extensions = 716,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 717,                    /* -fplugin-arg- */
  OPT_fplugin_ = 718,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 719,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 720,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 721,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 722,           /* -fprefetch-loop-arrays */
  ...
  OPT_freduced_reflection = 744,             /* -freduced-reflection */
  OPT_freg_struct_return = 745,              /* -freg-struct-return */
  OPT_fregmove = 746,                        /* -fregmove */
  ...
  OPT_fsched_rank_heuristic = 769,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 770,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 771,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 772,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 773,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 774,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 775,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 776,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 777,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 778,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 779,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 780, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 781,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 782,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 783,              /* -fsecond-underscore */
  OPT_fsection_anchors = 784,                /* -fsection-anchors */
  /* OPT_fsee = 785, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 786,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 787,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 788, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 789,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 790,          /* -fselective-scheduling2 */
  OPT_fshort_double = 791,                   /* -fshort-double */
  OPT_fshort_enums = 792,                    /* -fshort-enums */
  OPT_fshort_wchar = 793,                    /* -fshort-wchar */
  OPT_fshow_column = 794,                    /* -fshow-column */
  ...
  OPT_fsuppress_outer_loop_unroll = 823,     /* -fsuppress-outer-loop-unroll */
  ...
  OPT_ftword = 879,                          /* -ftword */
  OPT_ftword_stack = 880,                    /* -ftword-stack */
  ...
  OPT_fuse_balx = 892,                       /* -fuse-balx */
  OPT_fuse_boehm_gc = 893,                   /* -fuse-boehm-gc */
  ...
  OPT_fuse_tls = 898,                        /* -fuse-tls */
  OPT_fuse_uls = 899,                        /* -fuse-uls */
  ...
  OPT_fverbose_asm = 906,                    /* -fverbose-asm */
  /* OPT_fversion = 907, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 908,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 909,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 910,                    /* -fvisibility= */
  OPT_fvpt = 911,                            /* -fvpt */
  /* OPT_fvtable_gc = 912, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 913, */            /* -fvtable-thunks */
  OPT_fweak = 914,                           /* -fweak */
  OPT_fweb = 915,                            /* -fweb */
  OPT_fwhole_file = 916,                     /* -fwhole-file */
  OPT_fwhole_program = 917,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 918,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 919,              /* -fworking-directory */
  OPT_fwpa = 920,                            /* -fwpa */
  OPT_fwrapv = 921,                          /* -fwrapv */
  /* OPT_fxref = 922, */                     /* -fxref */
  OPT_fzee = 923,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 924,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 925,                      /* -fzero-link */
  OPT_g = 926,                               /* -g */
  OPT_gant = 927,                            /* -gant */
  OPT_gcoff = 928,                           /* -gcoff */
  OPT_gdwarf_ = 929,                         /* -gdwarf- */
  OPT_gen_decls = 930,                       /* -gen-decls */
  OPT_ggdb = 931,                            /* -ggdb */
  OPT_gnat = 932,                            /* -gnat */
  OPT_gnatO = 933,                           /* -gnatO */
  OPT_gno_strict_dwarf = 934,                /* -gno-strict-dwarf */
  OPT_gstabs = 935,                          /* -gstabs */
  OPT_gstabs_ = 936,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 937,                   /* -gstrict-dwarf */
  OPT_gtoggle = 938,                         /* -gtoggle */
  OPT_gvms = 939,                            /* -gvms */
  OPT_gxcoff = 940,                          /* -gxcoff */
  OPT_gxcoff_ = 941,                         /* -gxcoff+ */
  OPT_h = 942,                               /* -h */
  OPT_idirafter = 943,                       /* -idirafter */
  OPT_imacros = 944,                         /* -imacros */
  OPT_imultiarch = 945,                      /* -imultiarch */
  OPT_imultilib = 946,                       /* -imultilib */
  OPT_include = 947,                         /* -include */
  OPT_iplugindir_ = 948,                     /* -iplugindir= */
  OPT_iprefix = 949,                         /* -iprefix */
  OPT_iquote = 950,                          /* -iquote */
  OPT_isysroot = 951,                        /* -isysroot */
  OPT_isystem = 952,                         /* -isystem */
  OPT_iwithprefix = 953,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 954,               /* -iwithprefixbefore */
  OPT_k8 = 955,                              /* -k8 */
  OPT_l = 956,                               /* -l */
  OPT_lang_asm = 957,                        /* -lang-asm */
  OPT_mabi_ = 958,                           /* -mabi= */
  OPT_mabicalls = 959,                       /* -mabicalls */
  OPT_mad = 960,                             /* -mad */
  OPT_mandroid = 961,                        /* -mandroid */
  OPT_march_ = 962,                          /* -march= */
  OPT_mbionic = 963,                         /* -mbionic */
  OPT_mbranch_cost_ = 964,                   /* -mbranch-cost= */
  OPT_mbranch_likely = 965,                  /* -mbranch-likely */
  OPT_mce_ = 966,                            /* -mce= */
  OPT_mcheck_zero_division = 967,            /* -mcheck-zero-division */
  OPT_mcode_readable_ = 968,                 /* -mcode-readable= */
  OPT_mcpu_ = 969,                           /* -mcpu= */
  OPT_mdebug = 970,                          /* -mdebug */
  OPT_mdebugd = 971,                         /* -mdebugd */
  OPT_mdivide_breaks = 972,                  /* -mdivide-breaks */
  OPT_mdivide_traps = 973,                   /* -mdivide-traps */
  OPT_mdmx = 974,                            /* -mdmx */
  OPT_mdouble_float = 975,                   /* -mdouble-float */
  OPT_mdsp = 976,                            /* -mdsp */
  OPT_mdspr2 = 977,                          /* -mdspr2 */
  OPT_meb = 978,                             /* -meb */
  OPT_mel = 979,                             /* -mel */
  OPT_membedded_data = 980,                  /* -membedded-data */
  OPT_mexplicit_relocs = 981,                /* -mexplicit-relocs */
  OPT_mextern_sdata = 982,                   /* -mextern-sdata */
  OPT_mflip_mips16 = 983,                    /* -mflip-mips16 */
  OPT_mflush_func_ = 984,                    /* -mflush-func= */
  OPT_mfp_exceptions = 985,                  /* -mfp-exceptions */
  OPT_mfp32 = 986,                           /* -mfp32 */
  OPT_mfp64 = 987,                           /* -mfp64 */
  OPT_mfused_madd = 988,                     /* -mfused-madd */
  OPT_mglibc = 989,                          /* -mglibc */
  OPT_mgp32 = 990,                           /* -mgp32 */
  OPT_mgp64 = 991,                           /* -mgp64 */
  OPT_mgpopt = 992,                          /* -mgpopt */
  OPT_mhard_float = 993,                     /* -mhard-float */
  OPT_minterlink_mips16 = 994,               /* -minterlink-mips16 */
  OPT_mips = 995,                            /* -mips */
  OPT_mips16 = 996,                          /* -mips16 */
  OPT_mips3d = 997,                          /* -mips3d */
  OPT_mllsc = 998,                           /* -mllsc */
  OPT_mlocal_sdata = 999,                    /* -mlocal-sdata */
  OPT_mlong_calls = 1000,                    /* -mlong-calls */
  OPT_mlong32 = 1001,                        /* -mlong32 */
  OPT_mlong64 = 1002,                        /* -mlong64 */
  OPT_mmac = 1003,                           /* -mmac */
  OPT_mmcount_ra_address = 1004,             /* -mmcount-ra-address */
  OPT_mmemcpy = 1005,                        /* -mmemcpy */
  OPT_mmips_tfile = 1006,                    /* -mmips-tfile */
  OPT_mmt = 1007,                            /* -mmt */
  OPT_mno_data_in_code = 1008,               /* -mno-data-in-code */
  OPT_mno_float = 1009,                      /* -mno-float */
  OPT_mno_flush_func = 1010,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1011,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1012,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1013,                     /* -mno-mips3d */
  OPT_mpaired_single = 1014,                 /* -mpaired-single */
  OPT_mplt = 1015,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1016,           /* -mr10k-cache-barrier= */
  OPT_mradiax = 1017,                        /* -mradiax */
  OPT_mrelax_pic_calls = 1018,               /* -mrelax-pic-calls */
  OPT_msave_restore_mmd = 1019,              /* -msave-restore-mmd */
  OPT_mshared = 1020,                        /* -mshared */
  OPT_msimd = 1021,                          /* -msimd */
  OPT_msingle_float = 1022,                  /* -msingle-float */
  OPT_msmartmips = 1023,                     /* -msmartmips */
  OPT_msoft_float = 1024,                    /* -msoft-float */
  OPT_msplit_addresses = 1025,               /* -msplit-addresses */
  OPT_msym32 = 1026,                         /* -msym32 */
  OPT_msynci = 1027,                         /* -msynci */
  OPT_mtune_ = 1028,                         /* -mtune= */
  OPT_muclibc = 1029,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1030,        /* -muninit-const-in-rodata */
  OPT_munsafe_zero_overhead = 1031,          /* -munsafe-zero-overhead */
  OPT_mxgot = 1032,                          /* -mxgot */
  OPT_mzero_overhead = 1033,                 /* -mzero-overhead */
  OPT_n = 1034,                              /* -n */
  OPT_no_canonical_prefixes = 1035,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1036,              /* -no-integrated-cpp */
  OPT_noasmopt = 1037,                       /* -noasmopt */
  ...
  OPT_std_c1x = 1087,                        /* -std=c1x */
  /* OPT_std_c89 = 1088, */                  /* -std=c89 */
  OPT_std_c90 = 1089,                        /* -std=c90 */
  OPT_std_c99 = 1090,                        /* -std=c99 */
  /* OPT_std_c9x = 1091, */                  /* -std=c9x */
  OPT_std_f2003 = 1092,                      /* -std=f2003 */
  OPT_std_f2008 = 1093,                      /* -std=f2008 */
  OPT_std_f95 = 1094,                        /* -std=f95 */
  OPT_std_gnu = 1095,                        /* -std=gnu */
  OPT_std_gnu__0x = 1096,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1097,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1098,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1099, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1100,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1101,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1102, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1103, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1104,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1105, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1106, */         /* -std=iso9899:199x */
