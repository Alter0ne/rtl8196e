...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("/tmp/rsdk-4.6.4-2002/release/rsdk-4.6.4/linux/uclibc/mips-linux-uclibc/lib64"); SEARCH_DIR("=/usr/local/lib64"); SEARCH_DIR("=/lib64"); SEARCH_DIR("=/usr/lib64"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
