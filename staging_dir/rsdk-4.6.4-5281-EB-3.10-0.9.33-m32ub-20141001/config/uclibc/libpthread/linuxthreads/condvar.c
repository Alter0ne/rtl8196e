...
int attribute_protected __pthread_cond_init(pthread_cond_t *cond,
...
int attribute_protected __pthread_cond_destroy(pthread_cond_t *cond)
{
...
int attribute_protected __pthread_cond_wait(pthread_cond_t *cond, pthread_mutex_t *mutex)
{
  __volatile__ pthread_descr self = thread_self();
...
int attribute_protected __pthread_cond_timedwait(pthread_cond_t *cond, pthread_mutex_t *mutex,
			     const struct timespec * abstime)
{
...
int attribute_protected __pthread_cond_signal(pthread_cond_t *cond)
{
  pthread_descr th;
...
int attribute_protected __pthread_cond_broadcast(pthread_cond_t *cond)
{
...
int attribute_protected __pthread_condattr_init(pthread_condattr_t *attr)
{
  return 0;
}
strong_alias (__pthread_condattr_init, pthread_condattr_init)

int attribute_protected __pthread_condattr_destroy(pthread_condattr_t *attr)
{
  return 0;
}
