...
int attribute_protected __pthread_setcancelstate(int state, int * oldstate)
{
...
int attribute_protected __pthread_setcanceltype(int type, int * oldtype)
{
  pthread_descr self = thread_self();
...
void attribute_protected _pthread_cleanup_push(struct _pthread_cleanup_buffer * buffer,
...
void attribute_protected _pthread_cleanup_pop(struct _pthread_cleanup_buffer * buffer,
			  int execute)
{
  pthread_descr self = thread_self();
...
void attribute_protected _pthread_cleanup_push_defer(struct _pthread_cleanup_buffer * buffer,
				 void (*routine)(void *), void * arg)
{
  pthread_descr self = thread_self();
  buffer->__routine = routine;
...
void attribute_protected _pthread_cleanup_pop_restore(struct _pthread_cleanup_buffer * buffer,
				  int execute)
{
  pthread_descr self = thread_self();
  if (execute) buffer->__routine(buffer->__arg);
