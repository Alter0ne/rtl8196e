...
int attribute_protected __pthread_attr_init(pthread_attr_t *attr)
{
...
int attribute_protected __pthread_attr_destroy(pthread_attr_t *attr)
{
  return 0;
}
strong_alias (__pthread_attr_destroy, pthread_attr_destroy)

int attribute_protected __pthread_attr_setdetachstate(pthread_attr_t *attr, int detachstate)
{
...
int attribute_protected __pthread_attr_getdetachstate(const pthread_attr_t *attr, int *detachstate)
{
...
int attribute_protected __pthread_attr_setschedparam(pthread_attr_t *attr,
...
int attribute_protected __pthread_attr_getschedparam(const pthread_attr_t *attr,
...
int attribute_protected __pthread_attr_setschedpolicy(pthread_attr_t *attr, int policy)
{
...
int attribute_protected __pthread_attr_getschedpolicy(const pthread_attr_t *attr, int *policy)
{
...
int attribute_protected __pthread_attr_setinheritsched(pthread_attr_t *attr, int inherit)
{
...
int attribute_protected __pthread_attr_getinheritsched(const pthread_attr_t *attr, int *inherit)
{
...
int attribute_protected __pthread_attr_setscope(pthread_attr_t *attr, int scope)
{
  switch (scope) {
...
int attribute_protected __pthread_attr_getscope(const pthread_attr_t *attr, int *scope)
{
  *scope = attr->__scope;
  return 0;
}
