...
function Set.add_flags(self, flags)
    ...
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.add_flags(mbox, flags, self)
    end
end
...
function Set.remove_flags(self, flags)
    ...
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.remove_flags(mbox, flags, self)
    end
end
...
function Set.replace_flags(self, flags)
    ...
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.replace_flags(mbox, flags, self)
    end
end

function Set.mark_answered(self)
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.mark_answered(mbox, self)
    end
end

function Set.mark_deleted(self)
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.mark_deleted(mbox, self)
    end
end

function Set.mark_draft(self)
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.mark_draft(mbox, self)
    end
end

function Set.mark_flagged(self)
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.mark_flagged(mbox, self)
    end
end

function Set.mark_seen(self)
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.mark_seen(mbox, self)
    end
end

function Set.unmark_answered(self)
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.unmark_answered(mbox, self)
    end
end

function Set.unmark_deleted(self)
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.unmark_deleted(mbox, self)
    end
end

function Set.unmark_draft(self)
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.unmark_draft(mbox, self)
    end
end

function Set.unmark_flagged(self)
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.unmark_flagged(mbox, self)
    end
end

function Set.unmark_seen(self)
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.unmark_seen(mbox, self)
    end
end

function Set.delete_messages(self)
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.delete_messages(mbox, self)
    end
end
...
function Set.copy_messages(self, dest)
    ...
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.copy_messages(mbox, dest, self)
    end
end
...
function Set.move_messages(self, dest)
    ...
    for mbox in pairs(_extract_mailboxes(self)) do
        mbox.move_messages(mbox, dest, self)
    end
end
